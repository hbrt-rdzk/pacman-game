...
public class Player {
    ...
    public Player() throws IOException {
        this.x = 1;
        this.y = 1;
        pacManImage = ImageIO.read(new File("src/main/resources/images/pac_man.png"));
        pacManResized = pacManImage.getScaledInstance(GameConsts.BLOCK_SIZE, GameConsts.BLOCK_SIZE,
                Image.SCALE_DEFAULT);
    }
     ...
     * 
     * @param direction Direction in witch PacMan will be moving - Up, Down, Left or
     *                  Right.
     */
