...
public class Blinky extends Ghost {
    ...
    protected void paintGhost() throws IOException {
        ghostImage = ImageIO.read(new File("src/main/resources/images/blinky.png"));
        resizedGhostImage = ghostImage.getScaledInstance(GameConsts.BLOCK_SIZE, GameConsts.BLOCK_SIZE,
                Image.SCALE_DEFAULT);
    }

    /**
     * This method starts new thread and basing on the player's position, moves
     * blinky towards PacMan.
     * 
    ...
    private class Threader extends Thread {
        /**
         * This method calculates distance to pacman and if it can find a closer
         * position, the ghost makes a move.
